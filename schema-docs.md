...
| `service` | [`ExperimentalServiceInstrumentation`](#experimentalserviceinstrumentation) | `false` | If omitted, defaults as described in ExperimentalServiceInstrumentation are used. | No constraints. | Configure instrumentations following the service semantic conventions.<br>See service semantic conventions: https://opentelemetry.io/docs/specs/semconv/attributes-registry/service/<br> |
...
| `service` | not_applicable | unknown | supported | unknown | supported |
</details>
...
<pre>{
  ...
  "properties": {
    "service": {
      "$ref": "#/$defs/ExperimentalServiceInstrumentation",
      "description": "Configure instrumentations following the service semantic conventions.\nSee service semantic conventions: https://opentelemetry.io/docs/specs/semconv/attributes-registry/service/\nIf omitted, defaults as described in ExperimentalServiceInstrumentation are used.\n"
    },
    "http": {
...
## ExperimentalServiceInstrumentation <a id="experimentalserviceinstrumentation"></a>
...
| Property | [cpp](language-support-status.md#cpp) | [go](language-support-status.md#go) | [java](language-support-status.md#java) | [js](language-support-status.md#js) | [php](language-support-status.md#php) |
|---|---|---|---|---|---|
| `peer_mapping` | not_implemented | unknown | supported | unknown | supported |
</details>
...
* [`ExperimentalGeneralInstrumentation.service`](#experimentalgeneralinstrumentation)
...
* [`ExperimentalServiceInstrumentation.peer_mapping`](#experimentalserviceinstrumentation)
