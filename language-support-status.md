...
| [`ExperimentalGeneralInstrumentation`](schema-docs.md#experimentalgeneralinstrumentation) | not_applicable |  | * `http`: not_applicable<br>* `service`: not_applicable<br> |
...
| [`ExperimentalServiceInstrumentation`](schema-docs.md#experimentalserviceinstrumentation) | not_implemented |  | * `peer_mapping`: not_implemented<br> |
| [`ExperimentalServicePeerMapping`](schema-docs.md#experimentalservicepeermapping) | not_implemented |  | * `peer`: not_implemented<br>* `service_name`: not_implemented<br>* `service_namespace`: not_implemented<br> |
...
| [`ExperimentalGeneralInstrumentation`](schema-docs.md#experimentalgeneralinstrumentation) | unknown |  | * `http`: unknown<br>* `service`: unknown<br> |
...
| [`ExperimentalServiceInstrumentation`](schema-docs.md#experimentalserviceinstrumentation) | unknown |  | * `peer_mapping`: unknown<br> |
| [`ExperimentalServicePeerMapping`](schema-docs.md#experimentalservicepeermapping) | unknown |  | * `peer`: unknown<br>* `service_name`: unknown<br>* `service_namespace`: unknown<br> |
...
| [`ExperimentalGeneralInstrumentation`](schema-docs.md#experimentalgeneralinstrumentation) | supported |  | * `http`: supported<br>* `service`: supported<br> |
...
| [`ExperimentalServiceInstrumentation`](schema-docs.md#experimentalserviceinstrumentation) | supported |  | * `peer_mapping`: supported<br> |
| [`ExperimentalServicePeerMapping`](schema-docs.md#experimentalservicepeermapping) | supported |  | * `peer`: supported<br>* `service_name`: supported<br>* `service_namespace`: supported<br> |
